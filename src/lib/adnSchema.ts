...
export const ADN_SCHEMA_V8: ADNSeccion[] = [
  ...
  // ─── IRR · Irresistible · P4-P7 ────────────────────────────────────────────
  {
    ...
    campos: [
      ...
      { codigo: 'IRR.avatar_journey', label: 'Avatar · journey', pilarOrigen: 'P4.3', profileKey: 'adn_avatar_journey' },
      { codigo: 'IRR.avatar_objeciones', label: 'Avatar · objeciones', pilarOrigen: 'P4.3', profilePath: 'adn_avatar.objeciones' },
      { codigo: 'IRR.avatar_conexion_historia', label: 'Avatar · conexión con tu historia', pilarOrigen: 'P4.4', profileKey: 'adn_avatar_conexion_historia', criticoDia45: true },
      ...
      { codigo: 'IRR.micronicho', label: 'Micronicho', pilarOrigen: 'P5.2', profileKey: 'adn_micronicho', criticoDia45: true },
      { codigo: 'IRR.puv', label: 'PUV (Propuesta Única de Valor · para el nicho)', pilarOrigen: 'P5.3', profileKey: 'adn_usp', criticoDia45: true },
      ...
      { codigo: 'IRR.metodo_pasos', label: 'Pasos del método (3-7 · con nivel_oferta por paso)', pilarOrigen: 'P7.3', profileKey: 'metodo_pasos', criticoDia45: true },
      { codigo: 'IRR.metodo_mapeo_obstaculos', label: 'Mapeo Obstáculos B → Pasos del método', pilarOrigen: 'P7.4', profileKey: 'adn_metodo_mapeo_obstaculos' },
    ],
  },
  ...
  // ─── NEG · Negocio · P7-P8 ─────────────────────────────────────────────────
  {
    ...
    campos: [
      ...
      { codigo: 'NEG.oferta_mid', label: 'Oferta Mid ($1K-5K · DWY · principal)', pilarOrigen: 'P8.2', profileKey: 'oferta_mid', criticoDia45: true },
      { codigo: 'NEG.oferta_ultralow', label: 'Oferta Ultra Low ($17-47 · DIY)', pilarOrigen: 'P8.3', profileKey: 'adn_oferta_ultralow', criticoDia45: true },
      { codigo: 'NEG.lead_magnet', label: 'Lead Magnet ($0)', pilarOrigen: 'P8.4', profileKey: 'lead_magnet' },
      { codigo: 'NEG.oferta_low', label: 'Oferta Low ($100-500 · DIY)', pilarOrigen: 'P8.5', profileKey: 'oferta_low' },
      { codigo: 'NEG.oferta_high', label: 'Oferta High ($5K+ · DFY)', pilarOrigen: 'P8.6', profileKey: 'oferta_high' },
  ...
  // ─── INF · Infraestructura · P9A + P10 ─────────────────────────────────────
  {
    ...
    campos: [
      ...
      { codigo: 'INF.vsl_script', label: 'Script del VSL', pilarOrigen: 'P9A.2', profileKey: 'adn_vsl_script' },
      { codigo: 'INF.anuncios_meta_6_creativos', label: 'Anuncios Meta · 6 creativos N1/N2/N3', pilarOrigen: 'P9A.3', profileKey: 'adn_anuncios' },
      { codigo: 'INF.validacion_organica', label: 'Validación orgánica (mínimo 3 piezas)', pilarOrigen: 'P9A.4', profileKey: 'adn_validacion_organica' },
