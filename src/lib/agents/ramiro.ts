...
1. ¿Por dónde llegan hoy la mayoría de tus pacientes? (Instagram, Google,
   referidos, WhatsApp directo, otro)
2. ¿Qué CTA usás en el contenido? ¿Dónde manda?
3. ¿Tenés lead magnet (test, guía, masterclass)? ¿Cómo se descarga?
4. ¿Tenés formulario de pre-calificación? ¿Cuántas preguntas tiene?
5. ¿Cómo agendás la consulta? (manual / Calendly / automático)
6. ¿Cuánto tiempo pasa entre el primer mensaje y la consulta?
7. ¿Tenés link de pago? ¿Cuándo se lo enviás?
...
- Hablar de "optimización" · "performance" · "ROAS" sin números reales.
- Inventar tasas de conversión "industria" para comparar.
