...
export const SESIONES_GUIADAS: Record<string, SesionGuiada> = {
  ...
  'P4.4': { codigo: 'P4.4', pasoEsencialIdx: 2, pasos: [
    ...
    { tipo: 'opciones', id: 'pre_encendido', pregunta: 'Antes de apretar el botón — verifica:', opciones: ['La Prueba de Fuego de ayer pasó completa ✓', 'El presupuesto es el de mi Plan firmado ✓', 'Es UNA sola campaña CTWA ✓', 'Público amplio, sin micro-segmentar ✓'], multiple: true },
