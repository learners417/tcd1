...
[LA APP · 10s-1:30]
Tu pantalla principal es el Tablero. Ahí, todos los días, vas a ver una sola cosa grande: tu sesión de hoy. No pienses en los 90 días — pensá en el de hoy. El Tablero siempre te dice qué sigue.
El Camino es el mapa completo, por si querés ver a dónde vas. El ADN es tu negocio documentándose solo, sesión a sesión — al final es el manual de tu clínica. Y el Mentor está siempre, para cuando te trabes.
...
A los tuyos: a los que te formaron, y a los que dependen de vos. A tus pacientes: a los que ya ayudaste, y a los diez que todavía no te encontraron. Y a vos mismo: al profesional que decidió dejar de sobrevivir.
Vas a escribirlo con tus palabras, con fecha, y lo vas a firmar. En el dojo, la palabra empeñada es el primer cinturón. Hacelo ahora.`,
    esencia: 'El Tablero muestra tu sesión de hoy — pensá en el día, no en los 90. Una sesión por día, lu-vi, finde libre. Y antes de empezar: el Pacto, tu palabra empeñada a los tuyos, a tus pacientes y a vos mismo.',
  },
  ...
  'P1.1': {
    ...
    guion: `[GANCHO · 0-15s]
Te voy a decir por qué la mayoría de los cursos de negocios fracasan con profesionales como vos. Porque arrancan por la táctica — el embudo, los anuncios, el precio. Y se saltean la raíz.

[LA RAÍZ · 15s-1:30]
Vos ya sabés que valés más. Lo sabés hace años. Entonces, ¿por qué no lo cobrás? No es porque no sepas de marketing. Es porque algo adentro tuyo se activa cada vez que tenés que decir un número. Una incomodidad. Una culpa. Las manos que sudan.
...
Por eso empezamos acá. No porque sea lindo. Porque es lo que ninguna táctica puede arreglar por encima. Sanás esto, y todo lo demás — el precio, la oferta, la venta — deja de costar. Los próximos días son de esto. Sostené.`,
    esencia: 'La razón por la que no cobrás lo que valés no es técnica: es una relación rota con el dinero, casi siempre heredada de tu casa. Se ve en 3 sabotajes: bajar el precio preventivo, justificarlo con títulos, o trabajar de más por culpa. Sanamos esto primero porque ninguna táctica lo arregla por encima.',
  },
...
La idea del día: el dinero no vive solo en la cabeza — vive en el cuerpo. Cuando pensás en cobrar el doble, algo pasa físicamente. El pecho se cierra, el estómago se aprieta, la garganta se traba.
...
El Mentor te va a pedir que imagines decir tu precio nuevo en voz alta, frente a un paciente, y que notes QUÉ pasa en tu cuerpo. Sin juzgarlo. Solo notarlo. Porque lo que se nota, se puede soltar. Lo que se ignora, sigue mandando.`,
    esencia: 'El dinero no vive solo en la cabeza — vive en el cuerpo. Cuando pensás en cobrar más, algo se tensa físicamente. Esa reacción es la creencia vieja defendiéndose. Notarla, sin juzgarla, es el primer paso para soltarla.',
  },
  ...
  'P2.1': {
    ...
    guion: `[GANCHO · 0-15s]
Te voy a decir algo que probablemente no sabés de vos mismo: ya tenés un método. Hace años que lo usás. Solo que nunca lo sacaste de tu cabeza, y por eso no lo podés vender ni cobrar como lo que vale.

[EL PROBLEMA DE LO IMPLÍCITO · 15s-1:30]
Cuando un paciente mejora contigo, vos sabés por qué. Hay un orden en lo que hacés — una primera sesión que siempre es parecida, un momento en que pasa el click, una forma tuya de acompañar. Eso es un método. Pero si vive solo en tu intuición, pasan tres cosas: no lo podés repetir igual, no lo podés delegar, y no lo podés cobrar caro. Lo que no tiene nombre, no tiene precio.

[POR QUÉ IMPORTA · 1:30-2:30]
La gente no paga caro por sesiones sueltas. Paga caro por un proceso con nombre, con inicio y con final, que promete un resultado. "Diez sesiones de terapia" vale poco. "El Programa de Reconstrucción Emocional de 90 días" vale diez veces más — con el mismo conocimiento tuyo adentro. La diferencia no es lo que sabés. Es cómo lo empaquetás.

[EL AVATAR B · 2:30-3:15]
Y si sos de los que ya tienen años de práctica, esto es todavía más para vos. No vas a inventar nada. Vas a ORDENAR y ponerle nombre a lo que ya hacés hace quince años sin darte cuenta. Es tu activo más valioso, enterrado.
...
En las próximas sesiones vamos a sacar tu método de tu cabeza, ordenarlo en pasos, y ponerle un nombre que sea tuyo. Cuando lo veas en la pantalla, con nombre, algo va a cambiar en cómo te ves. Vas a dejar de ser alguien que da sesiones. Vas a ser el dueño de un método.`,
    esencia: 'Ya tenés un método — hace años que lo usás, solo que nunca lo sacaste de tu cabeza. Lo que no tiene nombre no tiene precio: la gente paga caro por un proceso con nombre, no por sesiones sueltas. Vamos a ordenarlo y nombrarlo. Ahí dejás de dar sesiones y pasás a ser dueño de un método.',
  },
...
[CIERRE · 3:30-4min]
En la próxima sesión vas a construir la tuya, con la herramienta, usando todo lo que ya cargaste: tu avatar, tu método, tus transformaciones. Va a salir una oferta que vos mismo comprarías. Y esa es la prueba de que está bien hecha.`,
  ...
  'P4.1': {
    codigo: 'P4.1',
    titulo: 'El sistema que trabaja por vos, sin humo',
    duracion: '3-4 min',
    proposito: 'Desmitificar el sistema de captación — sin jerga, como algo que cualquiera puede montar.',
    guion: `[GANCHO · 0-15s]
Ahora viene la parte que más asusta y menos debería: el sistema que te consigue pacientes sin que estés vos presente. Te lo voy a explicar sin una sola palabra rara.

[EL PROBLEMA DE HOY · 15s-1min]
Hoy tus pacientes llegan por boca a boca. Está buenísimo — pero tiene un techo: depende de que otros te recomienden, y no lo controlás vos. Si querés crecer sin depender de la suerte, necesitás un sistema que puedas prender y apagar. Eso es todo lo que vamos a construir.

[LAS CUATRO PIEZAS · 1-2:30]
Son cuatro piezas, y ya tenés casi todas. Uno: un mensaje que atrae a tu paciente ideal — no a cualquiera, al tuyo. Dos: un lugar donde ese mensaje vive, tu página. Tres: un asistente que responde a los interesados a cualquier hora, aunque estés durmiendo o atendiendo. Y cuatro: una agenda donde el interesado reserva una llamada con vos. Contenido que atrae, página que explica, asistente que responde, agenda que reserva. Eso es el sistema. Nada más.

[SIN MIEDO A LA TÉCNICA · 2:30-3:15]
Sé lo que estás pensando: "yo no sé de esto". No hace falta. Cada pieza tiene su tutorial paso a paso, y si te trabás, tenés al equipo y al Mentor. Miles de profesionales que le tenían pánico a la tecnología montaron esto. No sos la excepción.

[CIERRE · 3:15-4min]
Las próximas sesiones son las más técnicas del camino. Vas a instalar cada pieza, una por vez, sin apuro. Al final vas a tener algo que casi ningún colega tuyo tiene: una máquina de conseguir pacientes que funciona sin vos encima. Respirá hondo. Empezamos a instalar.`,
...
Dos caminos. Si ya tenés un dominio, hoy lo conectás — vas a copiar dos datos que se llaman registros DNS, pegarlos donde te muestro, y listo. Si no tenés, comprás uno simple: tu nombre, terminado en punto com, cuesta unos doce dólares al año. El tutorial te muestra cada clic.
...
[CIERRE · 2:15-3min]
Cuando termine, vas a tener un link con tu nombre que podés compartir con orgullo. Tu dirección en el mundo digital, tuya para siempre. Es un paso chico que cambia cómo te percibe la gente. Vamos.`,
    esencia: 'Tu clínica necesita una dirección digital propia (tu-nombre.com) — transmite seriedad, a diferencia de un link genérico. Si ya tenés dominio, lo conectás con 2 registros DNS (guiado paso a paso); si no, comprás uno simple (~$12/año). Si tarda horas en activarse, es normal.',
  },
...
[EL CAMBIO DE MARCO · 15s-1:15]
Vos ya sabés hacer esto — porque es exactamente lo que hacés con un paciente. No lo convencés de que está enfermo: le hacés preguntas hasta que ÉL entiende su problema y te pide ayuda. La venta es igual. No es un pitch. Es un diagnóstico. El que pregunta bien, cierra.

[LAS CINCO ETAPAS · 1:15-2:45]
La llamada tiene cinco momentos. Apertura: bajás la guardia, esto es una conversación, no un interrogatorio. Dolor: preguntás hasta que la persona pone en palabras lo que le duele — con SUS palabras, no las tuyas. Cielo: le hacés imaginar cómo sería su vida resuelto el problema. Obstáculos: qué lo frenó hasta ahora. Y recién ahí, cierre: presentás tu programa como el puente entre su dolor y su cielo. Si hiciste bien las primeras cuatro, el cierre casi se dice solo.

[EL PRECIO SIN TEMBLAR · 2:45-3:30]
Y cuando llega el precio, lo decís y te callás. No lo justifiques. No agregues "pero puedo hacerte un descuento". El precio se presenta, no se pide perdón por él. El silencio después del número es incómodo — bancátelo. El que habla primero, pierde.
...
En la próxima sesión vas a documentar tu protocolo, paso a paso. Es lo mismo que después va a vivir en Mi Clínica, tu app de operación, para que cada paciente lo siga solo. Entregás transformación, no disponibilidad. Esa es la diferencia entre un negocio y una condena.`,
  ...
  'P7.1': {
    ...
    guion: `[GANCHO · 0-15s]
Llegaste. Tenés tu método, tu oferta, tu sistema, tus primeras ventas. Ahora la pregunta cambia: ya no es "cómo consigo un paciente", es "cómo convierto esto en algo que funciona todos los meses sin mí encima".

[DE EJECUTAR A DIRIGIR · 15s-1:30]
Los primeros pacientes los conseguiste haciendo todo vos. Eso está bien para arrancar — pero no escala. La diferencia entre un profesional ocupado y un director de clínica es esta: el ocupado hace el trabajo; el director hace que el trabajo se haga. Tu campaña corre sola, tu asistente responde solo, tu agenda se llena sola. Vos revisás los números y ajustás. Dejaste de ser el sistema. Ahora lo dirigís.

[EL RITMO NUEVO · 1:30-2:30]
Tu semana ya no es cuarenta y cinco minutos de tarea. Es una revisión: qué números dieron, qué anuncio funcionó mejor, cuántas llamadas, cuántos cierres. Media hora por semana mirando el tablero y tomando una o dos decisiones. Eso es dirigir. El resto del tiempo — el que antes se comía tu negocio — ahora es tuyo. Para atender mejor, para tu familia, para vos.

[EL LEGADO · 2:30-3:30]
Y hay algo más grande. Vos empezaste como un profesional quemado, mártir de tu vocación. Y estás terminando como alguien que resolvió eso. Esa transformación es, ahora, tu mejor activo. Porque hay miles de colegas tuyos exactamente donde vos estabas hace noventa días. Sos libre. Ahora te toca liberar a otros.

[CIERRE · 3:30-4min]
Lo que sigue no es un final. Es tu clínica funcionando, y vos a cargo de verdad. La revisión semanal te va a acompañar de acá en adelante. Bienvenido al otro lado. Bienvenido, sanador libre.`,
    esencia: 'Ya tenés método, oferta, sistema y ventas. Ahora la diferencia es de ejecutar a dirigir: el ocupado hace el trabajo, el director hace que el trabajo se haga. Tu semana pasa a ser una revisión de 30 min de los números. El tiempo que antes se comía tu negocio ahora es tuyo. Sos libre — ahora te toca liberar a otros.',
  },
};
