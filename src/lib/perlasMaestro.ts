...
export const SEED_ROADMAP_V8: RoadmapPilar[] = [
  ...
  // ═══ FASE 2 · TU PROTOCOLO ═══
  {
    ...
    metas: [
      ...
      {
        codigo: 'P2.3b',
        titulo: 'Tu Matriz ABC — el lenguaje de tu paciente',
        ...
        checklist: [
          'Elige el dolor central de tu paciente',
      ...
      },
      {
        ...
        descripcion: 'Tu método ya tiene nombre. Ahora la frase que lo vende sola: a quién ayudas + qué transformación logras + qué te hace distinto. Una sola línea, con las palabras de tu paciente. Va primera en tu perfil y sale de tu boca cuando te preguntan a qué te dedicas. Si necesita explicación, todavía no es tu PUV.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '20 min',
        orden: 7,
...

  {
    ...
    metas: [
      ...
      },
      {
        ...
        descripcion: 'Antes de invertir un solo dólar en anuncios, cosecha lo que ya sembraste: escribe hoy a 10 personas que ya confiaron en ti — pacientes actuales, ex-pacientes, colegas que derivan. Mensaje personal, uno por uno, con nombre: les cuentas tu programa nuevo y les preguntas a quién le serviría. De aquí salen tus primeras ventas — las más naturales de todo el camino, sin gastar nada.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '45 min',
        orden: 6,
        ...
        entrenador: 'bruno',
        checklist: [
          'Arma tu lista de 10: pacientes actuales, ex-pacientes, colegas',
  ...
  // ═══ FASE 3 · CAPTACIÓN Y VENTAS ═══
  {
    ...
    metas: [
      ...
      {
        codigo: 'P4.2c',
        titulo: 'Tu PALABRA — la llave de tu campaña',
        descripcion:
          'Una sola palabra. Corta, en mayúsculas, ligada a tu oferta — nunca «INFO». La misma en todos tus anuncios: cambiarla rompe la medición. Hoy la eliges y la dejas escrita. Las otras dos que trabajaste siguen sirviendo para tu contenido de todos los días.',
        tipo: 'COACH',
        es_estrella: false,
      ...
      {
        codigo: 'P4.3d',
        titulo: 'Validación orgánica — publica antes de pagar',
        descripcion: 'Tus 3 piezas salen primero gratis a tu perfil. Miras cuál conversa mejor sin gastar un dólar: la que gana es la que después corre con inversión.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '1 h',
        orden: 9,
      ...
      {
        codigo: 'P4.6',
        titulo: 'El montaje — tus 8 candados',
        descripcion:
          'Nada se enciende hasta que TODO está tildado: tus 3 anuncios auditados, tu palabra probada con un comentario real, tu DM cargado, tu página con precio y agenda, el píxel activo, tu perfil ordenado, tu único trabajo claro y tu presupuesto definido. Un solo punto flojo quema el presupuesto entero. El checklist vive en Campañas.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '30 min',
        orden: 12,
      ...
      },
      {
        ...
        descripcion:
          'Una sola campaña. Un solo objetivo. Todos los días. Con 20-25 USD diarios compras lo barato — conversaciones — nunca lo caro. Y la regla de oro: los primeros 14 días no se opina, se mide. Hoy la enciendes y anotas la fecha: tu tablero cuenta desde aquí.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '30 min',
        orden: 13,
      ...
      },
      {
        ...
        descripcion: 'Ya tienes el sistema andando. Ahora la cuenta, para que dejes de trabajar con la sensación y empieces a trabajar con los números: 10 pacientes salen de unas 40 llamadas reales; 40 llamadas salen de unas 57 agendas (3 de cada 10 no se presentan, por eso confirmas 24 h y 2 h antes); y esas agendas salen de unas 300 conversaciones. Son 5 conversaciones por día y 5 llamadas por semana. Tu DM automático da la primera respuesta; tú atiendes a quienes contestan y tomas las llamadas. Cada viernes cargas 3 números en tu Tablero — conversaciones, llamadas, pacientes — y el Tablero te dice dónde está la fuga: si es volumen, si es filtro o si es cierre. Nunca más vas a adivinar qué corregir.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '20 min',
        orden: 14,
      ...
      },
{
        ...
        descripcion: 'La meta: 10 pacientes de tu precio digno, cobrados por tu sistema. Tus cobros verificados en Mi Clínica cuentan solos (el panel muestra tu camino al 10); sube ahí el último comprobante y tu Entrenador certifica tu Cinturón NEGRO. No con más horas — con mejor arquitectura. El árbol ya da semillas.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '20 min',
        orden: 8,
