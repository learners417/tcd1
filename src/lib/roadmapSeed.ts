  ...
  // ═══ FASE 1 · SANAR EL DINERO ═══
  {
    ...
    metas: [
      ...
      },
      {
        codigo: 'P1.3',
        titulo: 'LA QUEMA',
        descripcion: '¿Te suena a tontería quemar un papel? Es normal — y hay neurociencia detrás: el acto físico + la emoción + un testigo consolidan el cambio mucho más que solo pensarlo. El ritual que marca el quiebre: escribe en papel la creencia heredada que ya no quieres cargar, léela una última vez, y quémala físicamente. Sube la foto de las cenizas — queda en tu línea de tiempo. Al completarla ganas la punta amarilla: la semilla se abre.',
        tipo: 'COACH',
        es_estrella: true,
  ...
  // ═══ FASE 3 · CAPTACIÓN Y VENTAS ═══
  {
    ...
    metas: [
      ...
      },
      {
        ...
        descripcion: 'Hoy tus 3 piezas quedan listas: corte simple (inicio y final limpios), subtítulos automáticos, y subidas a tus plataformas. Nada de efectos: la claridad vende más que el brillo. En 2 horas están publicables.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '2 h',
        orden: 5,
        dia_asignado: 25,
        usa_ia: false,
        coach_instruccion: 'Edición mínima viable: CapCut o similar — cortar inicio/final, subtítulos automáticos, exportar vertical. Nada más. Si se traba con la herramienta técnica, resolvelo paso a paso. El objetivo del día: 3 piezas EXPORTADAS y listas. No se pule: se publica.',
        checklist: [
      ...
      },
      {
        ...
        descripcion: 'El momento que cambia todo. Apagás las 2 perdedoras y tu pieza CAMPEONA sube a $5-8/día como campaña a WhatsApp — donde tu agente ya espera para filtrar y agendar. Sube el screenshot de la campaña activa — un Entrenador lo verifica y ganas Verde punta azul: la planta se estira al cielo.',
        tipo: 'COACH',
        es_estrella: true,
