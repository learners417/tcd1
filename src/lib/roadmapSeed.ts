...
export const SEED_ROADMAP_V8: RoadmapPilar[] = [
  ...
  // ═══ FASE 0 · ONBOARDING ═══
  {
    ...
    metas: [
      ...
      },
      {
        ...
        descripcion: 'La sesión más corta y la más importante. Hoy recibes DOS llaves: EL CAMINO (esta app — donde te construyes, 90 días) y MI CLÍNICA (tu app de operación — donde tus {{consultantes}} de HOY se ordenan desde ya). Tu app en 5 minutos — y después, EL PACTO. No es un formulario: es una promesa. A los tuyos: a los que te formaron y a los que dependen de ti. A tus {{consultantes}}: a los que ya ayudaste y a los diez que todavía no te encontraron. Y a ti: al profesional que decidió dejar de sobrevivir. Vas a escribirlo con tus palabras, con fecha, y vas a firmarlo. En el dojo, la palabra empeñada es el primer cinturón.',
        tipo: 'VIDEO',
        es_estrella: true,
        tiempo_estimado: '5 min',
        orden: 4,
    ...
    metas: [
      ...
      },
      {
        ...
        checklist: [
          ...
          'Completa las 4 frases: "El dinero es…", "La gente rica es…", "Cobrar caro a un {{consultante}} es…", "Si gano mucho, mi familia…"',
      ...
      },
      {
        ...
        coach_instruccion: 'MODO AUDIO-FALLBACK: si el audio no está disponible, guía el trabajo somático (nombra la ciencia: van der Kolk, el cuerpo lleva la cuenta). Escaneo corporal guiado paso a paso: ojos cerrados, imagina cobrando su precio nuevo a un {{consultante}} real, registra dónde aparece tensión (1-10). Respiración 4-7-8 (práctica yóguica, declarada como práctica) tres veces sobre esa zona. Repetir la escena. Registrar el después (1-10). Pregunta: ¿qué cambió?',
      },
      {
        codigo: 'P1.5',
        titulo: 'EL NÚMERO — tu precio digno',
        descripcion: 'El momento central de la fase. La calculadora inversa te muestra: $10.000 ÷ 10 {{consultantes}} = $1.000 — el número no sale de tu miedo, sale de tu meta. Con tu Mentor lo haces TUYO: un número concreto, dicho en voz alta 3 veces sin disculparte (la tercera, grabandote un audio a ti mismo). El Mentor no aprueba precios-disculpa. Y al final, el cambio de idioma: ÓPTICA Y CÓDIGO. Todo es número — tu sesión, tu resultado, el dolor de {{tu_consultante}} y lo que pierde cada día que no te encuentra. Vas a cuantificar el costo de la inacción (qué hubiera pasado si no hacías este trabajo — en número) y te llevas la tarea del fin de semana: el ejercicio del Mall.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '30 min',
        orden: 5,
    ...
    metas: [
      {
        ...
        descripcion: 'Mira el video: por qué un método con nombre vale más que mil servicios sueltos, y cómo se poda: UNA transformación, UN protocolo, UN precio. Aplica igual si atiendes {{consultantes}} o formas estudiantes. Si el video no está, tu Mentor te lo cuenta.',
        tipo: 'VIDEO',
        es_estrella: false,
        tiempo_estimado: '6 min',
        orden: 1,
      ...
      },
      {
        ...
        descripcion: 'Dos cosas hoy. (1) Completa la herramienta con lo que YA haces con cada {{consultante}} (o estudiante), paso a paso. (2) EN PARALELO, 15 min con Sofi: crea tu página de Facebook y tu Business Manager HOY — Meta tarda semanas en confiar en cuentas nuevas, y tu campaña del día 22 necesita una cuenta con historial. Empezar hoy es lo que separa un plan serio de uno de humo.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
      ...
      {
        codigo: 'P2.3',
        titulo: '{{Tu_consultante}} ideal: los 3 mejores que tuviste',
        descripcion: 'Elige los 3 mejores {{consultantes}} (o estudiantes) que pasaron por ti y completa la herramienta. Extrae el patrón: quién es tu persona ideal, qué le duele, qué compró de verdad. ¿No tienes 3 {{consultantes}} todavía? Usa 3 personas cercanas que tengan el problema que resuelves — o tu propia historia: tú fuiste tu primer caso.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '1.5 h',
        orden: 3,
      ...
      {
        codigo: 'P2.3b',
        titulo: 'Tu Matriz ABC — el lenguaje de {{tu_consultante}}',
        descripcion: 'Ya sabes a quién sirves. Ahora sus palabras: A — lo que le duele, dicho como él lo dice (no como lo diría tu profesión). B — lo que ya intentó y no le alcanzó. C — la vida que quiere después. De esta matriz salen tus publicaciones, tus anuncios y tu llamada: todo lo que vas a escribir de acá en adelante sale de estas tres columnas.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '30 min',
        orden: 4,
        ...
        checklist: [
          'Elige el dolor central de {{tu_consultante}}',
          'Revisa las 3 columnas y ajusta con SUS palabras textuales',
          'Graba en tu ADN',
        ],
      },
      {
        ...
        descripcion: 'La herramienta usa tu proceso documentado + {{tu_consultante}} ideal y genera: 5 opciones de nombre propio (eliges una), tu protocolo estructurado en 3 a 7 pasos claros, y tu línea de posicionamiento (una frase que dice a quién sirves y qué transformas). Acá nace tu activo.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '1.5 h',
        orden: 5,
      ...
      },
      {
        ...
        descripcion: 'Cuéntale a tu Mentor el nombre elegido. La prueba de fuego: ¿evoca el RESULTADO que logra {{tu_consultante}}, o describe tu proceso técnico? El nombre tiene que prometer el destino. Al aprobar: Amarillo punta verde — el primer brote asoma.',
        tipo: 'COACH',
        es_estrella: true,
        ...
        dia_asignado: 13,
        usa_ia: false,
        coach_instruccion: 'Valida el nombre del método: ¿evoca el resultado del {{consultante}} o describe el proceso técnico? Si describe proceso, ayúdale a girarlo hacia el resultado. Cuando el nombre prometa el destino, aprueba y celebrá: Amarillo punta verde, el primer brote asoma.',
      },

      {
        codigo: 'P2.6',
        titulo: 'Tu PUV — la frase que te define',
        descripcion: 'Tu método ya tiene nombre. Ahora la frase que lo vende sola: a quién ayudas + qué transformación logras + qué te hace distinto. Una sola línea, con las palabras de {{tu_consultante}}. Va primera en tu perfil y sale de tu boca cuando te preguntan a qué te dedicas. Si necesita explicación, todavía no es tu PUV.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '20 min',
        orden: 7,
        ...
        checklist: [
          'Elige tu frase entre las que te propone',
          'Ajusta una palabra si hace falta — que suene a ti',
          'Graba en tu ADN: tu bio y tu presentación salen de acá',
        ],
      },
    ],
  },

  {
    ...
    metas: [
      ...
      {
        codigo: 'P3.4b',
        titulo: 'Tu Puerta Chica — para los que dicen "ahora no"',
        descripcion: 'De cada 4 personas que se sientan contigo, 3 van a decir que no al programa completo. Hoy, esas 3 se van con nada — y vuelven a su vida igual que llegaron. Tu Puerta Chica cambia eso: un tramo corto de TU mismo método, con precio de entrada, que se acredita al 100% si dentro de 30 días toman el programa entero. No es un descuento ni una versión recortada: es el primer escalón del mismo camino. Y solo se ofrece DESPUÉS del no, nunca antes.',
        tipo: 'HERRAMIENTA',
        es_estrella: false,
        tiempo_estimado: '30 min',
        orden: 7,
        ...
        checklist: [
          'Elige la forma de tu puerta chica',
          'Revisa el precio y la regla del crédito',
          'Aprende el momento: solo después del no',
          'Graba en tu ADN',
        ],
      },
      {
        codigo: 'P3.7',
        titulo: 'La transición de tu cartera',
        descripcion: 'Ya tienes tu oferta y tu precio. Falta lo que nadie te dice: qué pasa con los que hoy atiendes por mucho menos. Si no lo resuelves, vendes tu programa y a los dos meses sigues con la agenda ocupada por los de antes. Hoy separas a los tuyos en tres grupos — los que suben de precio, los que terminan su proceso y los que derivas — y escribes el mensaje exacto para cada uno. Esto no es abandonar a nadie: es darles un final, que es lo que un proceso serio tiene. Se desarrolla en el manual La Clínica.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '45 min',
        orden: 5,
        dia_asignado: 18,
        usa_ia: true,
        herramienta_id: 'H-P3.7',
        checklist: [
          'Lista a todos los que atiendes hoy y lo que te paga cada uno',
          'Reparte en tres grupos: suben, terminan, derivas',
          'Escribe el mensaje para cada grupo',
          'Pon fecha a cada conversación',
          'Graba tu transición en el ADN',
        ],
      },

      {
        codigo: 'P3.6',
        titulo: 'La Primera Cosecha — tu lista caliente',
        descripcion: 'Antes de invertir un solo dólar en anuncios, cosecha lo que ya sembraste: escribe hoy a 10 personas que ya confiaron en ti — {{consultantes}} actuales, ex-{{consultantes}}, colegas que derivan. Mensaje personal, uno por uno, con nombre: les cuentas tu programa nuevo y les preguntas a quién le serviría. De aquí salen tus primeras ventas — las más naturales de todo el camino, sin gastar nada.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '45 min',
        orden: 6,
        ...
        entrenador: 'bruno',
        checklist: [
          'Arma tu lista de 10: {{consultantes}} actuales, ex-{{consultantes}}, colegas',
          'Pide a Bruno el mensaje base y hazlo tuyo — personal, sin sonar a venta',
          'Envía los 10 hoy, uno por uno, con su nombre',
          'Sube captura de 3 conversaciones abiertas',
        ],
        coach_instruccion: 'La Primera Cosecha: ayudalo a armar su lista de 10 contactos calientes ({{consultantes}} actuales, ex-{{consultantes}}, colegas que derivan) y su mensaje personal — anuncio del programa nuevo + pregunta genuina de a quién le serviría, NUNCA un pitch ni un mensaje de difusión masiva. Revisa que suene a él. Evidencia: captura de 3 conversaciones abiertas. Si le da vergüenza escribir, recuérdale: estas personas ya confiaron en él una vez — merecen enterarse primero.',
      },
    ],
  },
  ...
  // ═══ FASE 3 · CAPTACIÓN Y VENTAS ═══
  {
    ...
    hito_mensaje: '🥋 Verde punta AZUL — la planta se estira al cielo. Tu campaña está ENCENDIDA y tu DM responde solo: empiezan a entrar conversaciones.',
    hito_tipo: 'urgent',
    mentor_pregunta: 'La campaña ya corre sin tú. ¿Qué vas a hacer con el tiempo que antes usabas para perseguir {{consultantes}}?',
    metas: [
      {
        codigo: 'P4.1',
        titulo: 'El circuito completo — así vende tu clínica',
        descripcion: 'El mapa de 6 pasos: tu anuncio filtra, tu palabra abre el DM, el DM entrega tu página, tu página muestra el precio en privado, la agenda trae la conversación y tú cierras. Ninguna pieza trabaja sola — y ninguna te pide más de 20-25 USD por día.',
        tipo: 'VIDEO',
        es_estrella: false,
        ...
        coach_instruccion: 'Recorre con la persona el circuito de 6 pasos hasta que lo pueda contar de memoria: anuncio → su PALABRA → el DM con su página → el precio en privado → la agenda → su conversación. Remarca la regla del dinero: la campaña compra conversaciones, nunca ventas — por eso alcanza con 20-25 USD por día. Si pregunta por herramientas, respóndele que cada pieza tiene su sesión más adelante.',
      },
      {
        codigo: 'P4.5',
        titulo: 'Tu DM automático — el link y UNA pregunta',
        descripcion:
          'Cuando alguien comenta tu palabra, tu respuesta automática hace dos cosas a la vez: entrega el link de tu página y hace UNA pregunta sobre su situación — nunca sobre tu programa. Si contesta, hay conversación. Si no, el camino sigue solo. Y a las 24-48 horas, un único seguimiento: «¿Pudiste verlo? ¿Qué te quedó dando vueltas?»',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '2 h',
        orden: 10,
        dia_asignado: 28,
        evidencia_requerida: { tipo: 'screenshot', descripcion: 'Captura del DM automático funcionando: comentaste tu palabra de prueba y llegó el mensaje con tu link.' },
        usa_ia: false,
        video_youtube_id: 'PLACEHOLDER_TUTORIAL_AGENTE',
        entrenador: 'sofi',
        checklist: [
          'Escribe tu respuesta automática: «¡Buenísimo! Acá tienes todo lo de [TU PROGRAMA] 👉 [LINK]. Míralo tranquilo y cuéntame: [TU PREGUNTA]»',
          'Elige TU pregunta — una sola, sobre su situación: «¿hace cuánto vienes con esto?» o «¿qué probaste hasta ahora?»',
          'Configúrala en tu herramienta de automatización para tu PALABRA exacta',
          'Pruébala con un comentario real desde otra cuenta: tiene que llegar el DM con tu link',
          'Programa el único seguimiento (24-48 h): «¿Pudiste verlo? ¿Qué te quedó dando vueltas?»',
        ],
        coach_instruccion: 'Verifica: (1) su respuesta automática escrita con el link REAL de su página; (2) su pregunta única elegida — sobre la situación, nunca sobre el programa; (3) la prueba hecha con un comentario real y el DM llegando; (4) el seguimiento de 24-48 h redactado. Sin DM no hay sistema: si algo falla, resuélvelo acá mismo.',
      },
      {
        codigo: 'P4.2',
        titulo: 'El mensaje que atrae a TU {{consultante}} ideal',
        descripcion: 'Genera con la herramienta el copy de tu página y tus anuncios: el mensaje que hace que tu persona ideal se detenga, se reconozca en el dolor y quiera hablar contigo. Usa {{tu_consultante}} ideal y tu oferta ya definidos. Es sesión-hito (2 h): puedes partirla en dos bloques — la app guarda todo donde lo dejes.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '2 h',
        orden: 2,
      ...
      {
        codigo: 'P4.2b',
        titulo: 'Tu perfil listo para recibir',
      ...
      {
        codigo: 'P4.2c',
        titulo: 'Tu PALABRA — tu recuperador',
        descripcion:
          'Tu campaña lleva a tu página: esto es otra cosa. Es lo que atiende a quien comenta tu contenido sin entrar. Una sola palabra, corta, en mayúsculas, ligada a tu oferta — nunca «INFO». La misma siempre: cambiarla rompe la medición. Hoy la eliges y la dejas escrita. Las otras dos que trabajaste siguen sirviendo para tu contenido de todos los días.',
        tipo: 'COACH',
        es_estrella: false,
        ...
        entrenador: 'sofi',
        checklist: [
          'Elige TU PALABRA de campaña: corta, en mayúsculas, ligada a tu oferta o a tu método — nunca «INFO»',
          'Elige 2 palabras más para tu contenido orgánico',
          'Anótalas: la de campaña será LA MISMA en todos tus anuncios — cambiarla rompe la medición',
        ],
        coach_instruccion: 'Ayúdale a elegir una palabra corta, pronunciable y ligada a su oferta (el nombre de su método suele funcionar). Rechaza INFO, CLARO, YA y toda palabra genérica. Confirma que entienda: una sola palabra para TODA la campaña.',
      },
      {
        codigo: 'P4.2d',
        titulo: 'Tu página de venta — el precio en privado',
        descripcion:
          'Acá vive tu venta completa: tu video, tu oferta, a quién sí y a quién no — y tu inversión visible, «desde $X». La agenda va DESPUÉS del precio: quien reserva ya vio el número. Con 3-4 preguntas obligatorias que te la traen lista. Y nada de regalos: lo gratis atrae curiosos; lo limitado atrae decididos.',
        tipo: 'HERRAMIENTA',
        es_estrella: false,
        tiempo_estimado: '45 min',
        orden: 5,
        dia_asignado: 23,
        usa_ia: true,
        herramienta_id: 'H-P4.2d',
        checklist: [
          'Elige el formato: guía en PDF o video de YouTube',
          'Genera y lee todo — ajusta lo que no suene a ti',
          'Imprime tu guía como PDF (o guarda el guion del video)',
          'Deja tu página lista: precio visible («desde \$X»), agenda DESPUÉS del precio y tus 3-4 preguntas de reserva activas',
        ],
      },
      {
        codigo: 'P4.3',
        titulo: 'Tus 3 anuncios — el Constructor',
        descripcion:
          'Tres fórmulas que atacan distinto: una desacredita el camino viejo, una conecta con lo que vive tu cliente, una muestra tu método con nombre. El Constructor las completa con tu ADN y las audita contra los 8 ingredientes — si faltan más de dos, la pieza no sale. Los tres terminan igual: invitando a ver tu video. Entras, generas, y sales con tus 3 guiones listos para grabar.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '5 días (en paralelo)',
        orden: 6,
        dia_asignado: 24,
        evidencia_requerida: { tipo: 'video', descripcion: 'Captura de tus 3 anuncios generados con su auditoría de ingredientes en verde.' },
        usa_ia: true,
      ...
      {
        codigo: 'P4.3e',
        titulo: 'Tu VSL — el video que vende por ti',
        descripcion: 'Tu página ya existe y tiene un hueco arriba: ahí vive el video que hace el trabajo pesado. No es un video institucional ni una presentación: es llevar a alguien que no te conoce desde el «a ver qué es esto» hasta el «quiero hablar con ella», en cinco minutos. Y no lo escribes de cero — tu historia, tu avatar, tu método, tu oferta y tu precio ya están en tu ADN. Hoy el Constructor los ordena en los bloques del VSL y sales con tu guion listo para grabar.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '1 h',
        orden: 7,
        dia_asignado: 24,
        usa_ia: true,
        herramienta_id: 'H-P4.3e',
        checklist: [
          'Genera tu guion con el Constructor',
          'Revisa que los primeros 30 segundos demuestren, no prometan',
          'Revisa que el precio aparezca antes de la agenda',
          'Revisa que haya UNA sola accion al final',
          'Graba tu VSL en el ADN',
        ],
      },
      {
        codigo: 'P4.2e',
        titulo: 'Tu formulario de filtro',
        descripcion: 'Esta es la pieza que decide la calidad de TODAS tus llamadas. Sin filtro, cualquiera reserva tu hora: el que esta averiguando, el que no puede pagarlo y el que tiene que hablarlo con alguien que no vino. Tres horas de tu vida para una conversacion real. Hoy defines las preguntas que se responden ANTES de ver tu calendario — y la que no califica no llega a tu agenda. Vas a ver menos agendas. Eso no es un error: es el objetivo.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '45 min',
        orden: 11,
        dia_asignado: 28,
        usa_ia: true,
        herramienta_id: 'H-P4.2e',
        checklist: [
          'Define tu minimo de inversion',
          'Revisa las 8 preguntas y ajusta los rangos a tu mercado',
          'Comprueba que la respuesta que no califica NO lleva al calendario',
          'Prueba el formulario por los dos caminos',
          'Graba tu formulario en el ADN',
        ],
      },
      {
        codigo: 'P4.9',
        titulo: 'Tu pagina de preparacion',
        descripcion: 'Lo que ve quien ya reservo, justo despues de confirmar. Sube muchisimo cuantos llegan decididos en vez de llegar a averiguar. Dice cuatro cosas: que va a pasar en los 45 minutos, que la decision se toma en la llamada y no despues, que si decide con alguien esa persona tiene que estar, y que llevar. Se arma una vez y trabaja para siempre.',
        tipo: 'HERRAMIENTA',
        es_estrella: false,
        tiempo_estimado: '45 min',
        orden: 13,
        dia_asignado: 29,
        usa_ia: true,
        herramienta_id: 'H-P4.9',
        checklist: [
          'Escribe los cuatro bloques con tus palabras',
          'Graba tu video corto de 3 minutos',
          'Comprueba que se muestra al confirmar una cita de prueba',
        ],
      },
      ...
      {
        codigo: 'P4.4',
        titulo: '🔥 ENCIENDE — tu campaña única',
        descripcion:
          'Una sola campaña. Un solo objetivo. Todos los días. Tu objetivo es que entren a tu página y vean tu video — nunca mensajes. Si pides mensajes, Meta te trae personas que escriben y no compran. Y la regla de oro: los primeros 14 días no se opina, se mide. Hoy la enciendes y anotas la fecha: tu tablero cuenta desde aquí.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '30 min',
        orden: 14,
        dia_asignado: 29,
        evidencia_requerida: { tipo: 'screenshot', descripcion: 'Captura de tu campaña encendida: el administrador de anuncios en «Activo».' },
        usa_ia: false,
        video_youtube_id: 'PLACEHOLDER_TUTORIAL_CAMPANA',
        entrenador: 'sofi',
        checklist: [
          'Apaga los 2 anuncios perdedores (sin culpa: pagaste $20 por saber la verdad)',
          'Crea UNA campaña de tráfico al perfil con tus 3 anuncios adentro, 20-25 USD/día en total',
          'Verifica el circuito completo: comentas tu PALABRA → llega tu DM con el link → tu página abre → la agenda funciona',
      ...
      {
        codigo: 'P4.7',
        titulo: 'Tu Tablero de Números — la cuenta de los 10',
        descripcion: 'Ya tienes el sistema andando. Ahora la cuenta, para que dejes de trabajar con la sensación y empieces a trabajar con los números: 10 {{consultantes}} salen de unas 40 llamadas reales; 40 llamadas salen de unas 57 agendas (3 de cada 10 no se presentan, por eso confirmas 24 h y 2 h antes); y esas agendas salen de unas 300 conversaciones. Son 5 conversaciones por día y 5 llamadas por semana. Tu DM automático da la primera respuesta; tú atiendes a quienes contestan y tomas las llamadas. Cada viernes cargas 3 números en tu Tablero — conversaciones, llamadas, {{consultantes}} — y el Tablero te dice dónde está la fuga: si es volumen, si es filtro o si es cierre. Nunca más vas a adivinar qué corregir.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '20 min',
        orden: 15,
        ...
        entrenador: 'mentor',
        checklist: [
          'Mira tu Tablero en Hoy: la cadena completa con tus números',
          'Escribe tu meta de esta semana: conversaciones y llamadas',
          'Agenda el rito del viernes: cargar los 3 números',
        ],
        coach_instruccion: 'EL TABLERO. Explícale su cuenta con SUS números, sin jerga: de la meta hacia atrás (10 {{consultantes}} ← 40 llamadas ← 57 agendas ← 300 conversaciones) y bajala a la semana. Dejale grabada la idea madre: el problema casi nunca es la técnica, es el volumen — y cuando no es volumen, es filtro; y cuando no es filtro, es cierre. Cierra fijando el rito del viernes: 3 números, un diagnóstico, una acción. Si se asusta con los números, recuérdale que su DM da la primera respuesta: solo toma 5 llamadas por semana.',
      },
      {
        ...
        checklist: [
          ...
          'Sigue el link como lo seguiría un {{consultante}}',
...

  {
    ...
    metas: [
      ...
      {
        codigo: 'P5.6',
        titulo: 'La autopsia de tu llamada',
        descripcion: 'Tu llamada no mejora recordando: mejora escuchandote. Hoy subes la grabacion de tu primera llamada real y la medimos contra tu propio script. Cuatro numeros y ninguna opinion: en que minuto dijiste el precio, cuantas preguntas hiciste antes de presentar, cuantos segundos de silencio dejaste despues del numero, y si pediste la decision. La primera llamada siempre sale mal y eso no significa nada. Lo que significa algo es no mirarla.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '30 min',
        orden: 6,
        ...
        usa_ia: true,
        checklist: [
          'Sube la grabacion o la transcripcion de tu llamada',
          'Mira los cuatro numeros',
          'Elige UNA sola cosa para cambiar en la proxima',
          'Anota esa cosa en tu script',
        ],
      },
    ],
  },
  ...
  // ═══ FASE 4 · SERVICIO Y ESCALA ═══
  {
    ...
    subtitulo: 'Tu primer pago, tu app con tu marca, y un servicio que no te consume',
    color: '#EF4444',
    numero: 6,
    ...
    hito_mensaje: '🥋 Cinturón ROJO — el fruto maduró. Cobraste tu primer {{consultante}} por el sistema. El mártir quedó atrás.',
    hito_tipo: 'milestone',
    ...
    metas: [
      {
        ...
        descripcion: 'Mira el video: el protocolo de entrega — qué recibe {{tu_consultante}} en las primeras 24 hs, cómo se organiza el seguimiento, qué se automatiza y qué se mantiene humano. Acá nace tu MiClínica Digital. Si el video no está, tu Mentor te lo cuenta.',
        tipo: 'VIDEO',
        es_estrella: false,
        tiempo_estimado: '7 min',
        orden: 1,
        ...
        coach_instruccion: 'MODO VIDEO-FALLBACK: en 5 min — el error clásico es vender bien y entregar caótico (el {{consultante}} paga $1.000 y recibe silencio 3 días). El protocolo: (1) primeras 24 hs — bienvenida + primer paso concreto; (2) la primera sesión agendada YA en el momento del pago; (3) recordatorios y seguimiento con estructura (qué es automático, qué es humano); (4) el cierre del protocolo con medición del resultado. Todo esto después vive en MiClínica Digital — tu app operativa. Hoy lo documenta para tenerlo listo.',
      },
      {
        codigo: 'P6.4',
        titulo: 'El ritmo de ventas — tu semana tipo',
        descripcion: 'Desde hoy, tu semana tiene forma fija: mañanas de entrega a tus {{consultantes}}, ventana de leads al mediodía, llamadas por la tarde, y el viernes tu Revisión del Director. Este es el ritmo que sostiene los 10. No es intensidad: es constancia con forma. El taekwondo no se gana en un día de furia — se gana en mil días de presencia. Y en los huecos entre llamadas, tu audiencia crece: 1 reel + 1 carrusel por semana con Mateo, con las fórmulas de siempre y UNA de tus 3 palabras como único llamado.',
        tipo: 'COACH',
        es_estrella: false,
        ...
        checklist: [
          ...
          'Pide testimonio a cada {{consultante}} que termina — tu prueba social vende por ti',
        ],
      },
      {
        codigo: 'P6.2',
      ...
      },
      {
        ...
        descripcion: 'Alguien dijo que sí y pagó tu precio digno. Regístralo en Mi Clínica (tu app de gestión, en el menú) con su comprobante: tu Cinturón ROJO se acredita solo desde ahí — un comprobante, las dos apps. ¿Aún no tienes Mi Clínica conectada? Sube el comprobante aquí y tu Entrenador lo verifica. El fruto maduró: este es el final del mártir.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '15 min',
        orden: 4,
      ...
      {
        codigo: 'P6.5',
        titulo: 'Por que tu app va ahora y no antes',
        descripcion: 'Te dije desde el dia 1 que ibas a tener tu app, y te hice esperar. Ahora sabes por que: una app sin nadie adentro es una carpeta vacia, y armar carpetas vacias es la forma mas elegante de no vender. Ya cobraste. Ya tienes a alguien real esperando. Hoy tu app se pone tu marca: tu nombre, tu logo, tu color. Lo que resuelve es que dejes de repetir lo mismo por WhatsApp cuarenta veces por semana. Lo que NO resuelve: no vende, no consigue {{consultantes}} y no reemplaza tus sesiones. Se desarrolla en el manual La Clinica.',
        tipo: 'VIDEO',
        es_estrella: false,
        tiempo_estimado: '20 min',
        orden: 5,
        ...
        usa_ia: false,
        checklist: [
          'Entra por primera vez a tu app',
          'Elige tu subdominio',
          'Sube tu logo y elige tu color',
          'Mira como la va a ver {{tu_consultante}}',
        ],
      },
      {
        codigo: 'P6.6',
        titulo: 'Trae tu metodo y arma tus etapas',
        descripcion: 'No tienes que cargar nada a mano. Un boton trae tu protocolo de entrega, tu {{consultante}} ideal y tu catalogo desde aqui. Despues armas tus etapas semana por semana y decides que desbloquea cada una. Un consejo que te ahorra dias: carga las primeras cuatro semanas, no las doce. Lo que aprendas con {{tu_consultante}} numero uno te va a cambiar las otras ocho, y si ya las hiciste, las vas a rehacer.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '1.5 h',
        orden: 6,
        dia_asignado: 46,
        usa_ia: true,
        herramienta_id: 'H-APP.1',
        checklist: [
          'Aprieta el boton que trae tu metodo',
          'Revisa que llego bien y corrige lo que haga falta',
          'Arma tus primeras 4 etapas',
          'Define que desbloquea cada una',
        ],
      },
      {
        codigo: 'P6.7',
        titulo: 'Dia de grabacion 2 — los videos de tus etapas',
        descripcion: 'Una sentada, todos los videos de tus etapas. El criterio de que grabar primero es simple y no es el que te va a salir solo: graba lo que ya repites cuarenta veces por semana, no lo que te parece mas lindo. Eso es lo que te devuelve horas. Misma ropa, mismo lugar, uno detras de otro.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '3 h',
        orden: 7,
        ...
        usa_ia: false,
        checklist: [
          'Lista lo que repites todas las semanas',
          'Graba un video corto por etapa',
          'Subelos y asigna cada uno a su etapa',
        ],
      },
      {
        codigo: 'P6.8',
        titulo: 'Tus ejercicios y tus materiales',
        descripcion: 'Lo que hoy mandas suelto por WhatsApp vive en un solo lugar y se carga una vez: tus ejercicios, tus documentos, tus audios. Cada uno en la etapa donde corresponde. A partir de hoy, atender a diez te cuesta lo mismo que atender a uno.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '1 h',
        orden: 8,
        ...
        usa_ia: true,
        checklist: [
          'Junta lo que ya mandas por WhatsApp',
          'Subelo y asignalo a su etapa',
          'Revisa que se vea bien desde un celular',
        ],
      },
      {
        codigo: 'P6.9',
        titulo: 'Tu primer {{consultante}} adentro',
        descripcion: 'El que cierra el sistema. Y antes de invitar a nadie, un paso que evita el peor papelon: comprate a ti mismo desde el telefono, con una tarjeta de verdad. Recorre lo que va a recorrer esa persona. Si el correo no llega o algo no abre, lo descubres tu y no {{tu_consultante}}. Despues lo invitas, y le dices esto: "Te arme un espacio donde vas a tener todo lo que trabajamos. Entra cuando puedas y mira la primera etapa, que la proxima sesion arrancamos desde ahi." Se desarrolla en el manual La Clinica.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '30 min',
        orden: 9,
        ...
        usa_ia: true,
        checklist: [
          'Comprate a ti mismo desde el telefono',
          'Recorre lo que va a recorrer esa persona',
          'Invita a {{tu_consultante}}',
          'Sube captura de su avance',
        ],
      },
    ],
  },

  {
    ...
    hito_mensaje: '🥋 Cinturón NEGRO — el árbol da semillas. 10 {{consultantes}}, $10K, sistema andando. Eres un Sanador Libre. Y esto recién empieza.',
    hito_tipo: 'milestone',
    ...
    metas: [
      ...
      },
      {
        ...
        checklist: [
          ...
          'Pide testimonio a cada {{consultante}} que termina (video de 60 seg o audio) — tu prueba social vende por ti',
        ],
      ...
      {
        codigo: 'P7.4',
        titulo: 'Por que tu marca va ultima',
        descripcion: 'Llevas cincuenta dias conmigo y todavia no te pedi que subas nada. Eso no fue un descuido. No hay relacion directa entre publicar y facturar: hay profesionales con miles de seguidores que no llegan a fin de mes, y otros con trescientos que facturan diez mil. Lo que cambio en estos cincuenta dias es que ahora tienes una oferta clara, un precio que sostienes y un lugar a donde mandar a la gente. Antes no tenias ninguna de las tres. Y una cosa mas: el contenido que trae {{consultantes}} no ensena, filtra.',
        tipo: 'VIDEO',
        es_estrella: false,
        tiempo_estimado: '15 min',
        orden: 4,
        dia_asignado: 53,
        usa_ia: false,
        checklist: ['Mira el video', 'Entiende por que el plan se escribe pero no se ejecuta en estos 90 dias'],
      },
      {
        codigo: 'P7.5',
        titulo: 'Tus tres temas del trimestre',
        descripcion: 'Tu contenido no sale de lo que esta de moda: sale de tu Matriz ABC, que hiciste el dia 12 con las palabras literales de quienes atiendes. Hoy eliges tres enfoques para los proximos tres meses. Tres, no diez: lo que se repite es lo que se recuerda.',
        tipo: 'HERRAMIENTA',
        es_estrella: false,
        tiempo_estimado: '45 min',
        orden: 5,
        dia_asignado: 53,
        usa_ia: true,
        herramienta_id: 'H-MARCA.1',
        checklist: ['Revisa tu Matriz ABC', 'Elige tus 3 enfoques', 'Graba en tu ADN'],
      },
      {
        codigo: 'P7.6',
        titulo: 'Tu perfil que sostiene la promesa',
        descripcion: 'Ya ordenaste tu perfil el dia 22 para que no pareciera abandonado. Esto es otra cosa: que tu perfil diga lo mismo que tu pagina, tu video y tu llamada. Un solo mensaje en cuatro lugares. Bio, fijados y destacadas alineados a tu promesa.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '45 min',
        orden: 7,
        dia_asignado: 60,
        usa_ia: true,
        checklist: ['Alinea tu bio con tu promesa', 'Define tus 3 fijados', 'Sube captura'],
      },
      {
        codigo: 'P7.7',
        titulo: 'Las doce semanas escritas',
        descripcion: 'El entregable del sistema 5: tu trimestre completo, escrito. Doce piezas con su gancho y su orden, repartidas entre tus tres enfoques. Se escribe hoy y se graba en un solo dia. Un dia de grabacion, un mes tranquilo. En estos 90 dias escribes el plan; ejecutarlo es el programa que sigue.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '1 h',
        orden: 9,
        dia_asignado: 67,
        usa_ia: true,
        herramienta_id: 'H-MARCA.2',
        checklist: ['Genera tus 12 piezas', 'Revisa que cada una tenga gancho', 'Ordenalas por semana', 'Graba tu plan trimestral en el ADN'],
      },
      {
        codigo: 'P7.8',
        titulo: 'Dia de grabacion 3 — el primer lote',
        descripcion: 'Las cuatro piezas del primer mes, de una sentada. Misma ropa, mismo lugar, una detras de otra. Lo importante no es que salgan perfectas: es que salgan. Hecho es mejor que perfecto, y este es el rito que vas a repetir una vez por mes para siempre.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '2 h',
        orden: 11,
        dia_asignado: 74,
        usa_ia: false,
        checklist: ['Graba las 4 piezas del primer mes', 'Edicion simple', 'Sube captura del lote'],
      },
      {
        codigo: 'P7.9',
        titulo: 'Tu calendario cargado y tu rito mensual',
        descripcion: 'Cargas el lote, eliges dias y horarios, y lo dejas andando. Y fijas el rito: un dia de grabacion por mes, siempre el mismo. Sin rito, el contenido se convierte en una deuda diaria.',
        tipo: 'HERRAMIENTA',
        es_estrella: false,
        tiempo_estimado: '30 min',
        orden: 13,
        dia_asignado: 81,
        usa_ia: false,
        checklist: ['Programa tus 4 piezas', 'Fija tu dia de grabacion mensual', 'Sube captura del calendario'],
      },
      {
        codigo: 'P7.10',
        titulo: 'El tablero de los cinco sistemas',
        descripcion: 'Aqui se verifica tu garantia, y no con una opinion: con evidencia. Cada sistema queda en verde, amarillo o rojo contra algo que exista. Tu precio sellado. Tu oferta aprobada. Tu campana con datos. {{Tu_consultante}} avanzando en tu app. Tu trimestre escrito. Lo que quede en amarillo es lo que seguimos trabajando sin costo — y el tablero dice cual y por que.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '45 min',
        orden: 15,
        dia_asignado: 86,
        usa_ia: true,
        herramienta_id: 'H-CIERRE.1',
        checklist: ['Revisa la evidencia de cada sistema', 'Marca verde, amarillo o rojo', 'Graba tu tablero'],
      },
      {
        codigo: 'P7.11',
        titulo: 'Tu foto de llegada',
        descripcion: 'Hoy contestas las mismas preguntas del dia 1. No mires las respuestas viejas hasta haber contestado las de hoy. Y cuando las compares, mira algo mas que el numero: el numero importa menos que la forma en que lo conseguiste.',
        tipo: 'HERRAMIENTA',
        es_estrella: false,
        tiempo_estimado: '30 min',
        orden: 16,
        dia_asignado: 87,
        usa_ia: false,
        checklist: ['Contesta sin mirar la Foto de Partida', 'Compara despues', 'Guarda las dos juntas'],
      },
      {
        codigo: 'P7.12',
        titulo: 'Tu plan de los proximos 180 dias',
        descripcion: 'Terminaste noventa dias con una clinica digital funcionando. Lo que sigue no es construir: es que te conozcan. Y eso no se hace en noventa dias. Hoy escribes el mapa de tus proximos seis meses de marca, con tu nombre arriba: que publicas, en que orden, con que medicion y que entra cada mes. Te lo llevas, lo hagas conmigo o lo hagas solo.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
        tiempo_estimado: '1 h',
        orden: 17,
        dia_asignado: 88,
        usa_ia: true,
        herramienta_id: 'H-CIERRE.2',
        checklist: ['Genera tu plan de 180 dias', 'Revisa que tenga medicion', 'Graba tu plan en el ADN'],
      },
      {
        codigo: 'P7.13',
        titulo: 'Tu graduacion',
        descripcion: 'Si los cinco sistemas estan en verde, cumplimos los dos. Si alguno quedo en amarillo, arranca el acompanamiento sin costo hasta que este andando — y tu tablero dice exactamente cual y por que. Eso es lo que firmamos el dia 1.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '30 min',
        orden: 18,
        dia_asignado: 90,
        usa_ia: true,
        checklist: ['Revisa tu tablero de los cinco', 'Reconoce lo que construiste', 'Define tu siguiente paso'],
      },
      {
        codigo: 'P7.C5',
...
{
        codigo: 'P7.3',
        titulo: '◆ 10 {{Consultantes}} · SANADOR LIBRE',
        descripcion: 'La meta: 10 {{consultantes}} de tu precio digno, cobrados por tu sistema. Tus cobros verificados en Mi Clínica cuentan solos (el panel muestra tu camino al 10); sube ahí el último comprobante y tu Entrenador certifica tu Cinturón NEGRO. No con más horas — con mejor arquitectura. El árbol ya da semillas.',
        tipo: 'COACH',
        es_estrella: true,
        tiempo_estimado: '20 min',
        orden: 14,
        dia_asignado: 85,
        usa_ia: false,
        evidencia_requerida: { tipo: 'comprobante', descripcion: 'El registro de tus 10 {{consultantes}}: capturas de los pagos o tu planilla de cobros. El Cinturón Negro se gana con hechos — como todos los anteriores.' },
        coach_instruccion: 'Certificación del Cinturón Negro: pídele evidencia de los 10 {{consultantes}} cobrados (comprobantes o el registro de ventas). Verifica que la suma alcance ~$10K. Si es válido, certificá: Sanador Libre. La retrospectiva: ¿qué cambió en 90 días — en su negocio Y en él? El después: el sistema ahora produce 10/mes, su clínica opera en MiClínica Digital, y el cinturón negro es 1er dan — el Nivel 2 ($25K/mes) existe cuando esté listo.',
      },
    ],
  },
];
...
export const CINTURONES: Cinturon[] = [
  ...
  { id: 'blanco_punta_amarilla', orden: 2, nombre: 'Blanco punta amarilla', emoji: '⬜🟡', color: '#F4F4F5', color_punta: '#B0822E', metafora: 'La semilla se abre' },
  { id: 'amarillo',              orden: 3, nombre: 'Amarillo',              emoji: '🟡',   color: '#B0822E',                          metafora: 'La raíz en la tierra' },
  { id: 'amarillo_punta_verde',  orden: 4, nombre: 'Amarillo punta verde',  emoji: '🟡🟢', color: '#B0822E', color_punta: '#22C55E', metafora: 'El primer brote asoma' },
