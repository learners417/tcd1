...
export const SEED_ROADMAP_V8: RoadmapPilar[] = [
  ...
  // ═══ FASE 3 · CAPTACIÓN Y VENTAS ═══
  {
    ...
    metas: [
      ...
      {
        codigo: 'P4.2c',
        titulo: 'Tus 3 palabras clave',
        descripcion: 'Define las 3 palabras que vas a usar SIEMPRE — en tu bio, en cada pieza y en tus anuncios. Los roles son fijos, las palabras son tuyas: 1) la del RECURSO — regalas tu guía; 2) la de la CONSULTA — van directo a tu agenda; 3) la de tu MÉTODO — piden info de tu programa. Regla de oro: cada pieza lleva UNA sola palabra, y son estas 3 para siempre. Tu agente las reconoce y responde solo.',
        tipo: 'COACH',
        es_estrella: false,
        ...
        entrenador: 'sofi',
        checklist: [
          'Elige tu palabra del RECURSO (ej: GUIA)',
          'Elige tu palabra de la CONSULTA (ej: CONSULTA)',
          'Elige la de tu MÉTODO (el nombre de tu método)',
          'Pide a Sofi que las sume al documento de tu agente',
        ],
        coach_instruccion: 'Ayudalo a elegir 3 palabras simples y memorables, una por rol: recurso / consulta / método. Cortas, sin espacios, fáciles de escribir desde un teléfono. Cuando las tenga, generale la sección nueva del documento de su agente: qué responde ante cada palabra (RECURSO → entrega la guía + 2 mensajes de valor + invita a la agenda; CONSULTA → preguntas de filtro → agenda; MÉTODO → presenta el programa → agenda). Cerrá con la regla: una palabra por pieza, siempre las mismas 3.',
      },
      {
        codigo: 'P4.2d',
        titulo: 'Tu Recurso Principal — lo que regalas',
        descripcion: 'Tu palabra del RECURSO necesita algo que regalar. En 45 minutos lo tienes entero: la herramienta te genera tu guía (o el guion de tu video), el guion de tu VSL para la página de agenda, y los 3 mensajes con los que tu agente lo entrega. Revisa, ajusta con tus palabras, y guarda. Mañana lo grabas todo en tu Día de Grabación.',
        tipo: 'HERRAMIENTA',
        es_estrella: false,
        tiempo_estimado: '45 min',
        orden: 3,
        ...
        checklist: [
          ...
          'Pasa los 3 mensajes de entrega a Sofi para tu agente',
        ],
      },
      {
        codigo: 'P4.3',
        titulo: 'Graba 3 piezas y valídalas con datos REALES',
        descripcion: 'Regla de Javo: "No corro publicidad sin validar. Perdí $150.000 por esto." Pero con una cuenta chica, el orgánico solo no alcanza como señal — así que validamos con datos pagados y baratos: publicas las 3 piezas orgánico (gratis, construye tu perfil) Y las corrés como 3 anuncios de $2/día durante 5 días. El algoritmo de Meta te dice cuál GANA con números reales, no con corazonadas. Mateo te arma los guiones; Caro te enseña a grabar. Las 3 fórmulas, para siempre: CARRUSEL — el resultado en la portada → por qué lo viejo no alcanza → tu prueba → tu método en 3-4 pasos → tu palabra clave. REEL — gancho con el resultado en el segundo cero → los 3-4 puntos de tu método (el qué, no el cómo) → tu palabra clave. TEXTO — beneficio directo → el problema y el cambio de enfoque → tu historia → el descubrimiento → resultados → tu palabra clave.',
        tipo: 'HERRAMIENTA',
        es_estrella: true,
      ...
      },
      {
        ...
        descripcion: 'Además de la campaña CTWA que trae interesados a tu WhatsApp, corre en paralelo un anuncio pequeño ($5/día, fijo todo el reto) cuyo único objetivo es que la gente correcta SIGA tu perfil. Usa tu mejor pieza ya validada. Cada seguidor correcto es un futuro paciente calentándose solo. Sube captura del anuncio configurado. Y esto no es solo un número: es que la gente te vea. Cada seguidor nuevo, cada comentario, es combustible — y ese público que hoy te descubre es al que mañana le vuelves a aparecer cuando toque vender.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '30 min',
        orden: 7.5,
      ...
      },
      {
        ...
        descripcion: 'Ya tienes el sistema andando. Ahora la cuenta, para que dejes de trabajar con la sensación y empieces a trabajar con los números: 10 pacientes salen de unas 40 llamadas reales; 40 llamadas salen de unas 57 agendas (3 de cada 10 no se presentan, por eso confirmas 24 h y 2 h antes); y esas agendas salen de unas 300 conversaciones. Son 5 conversaciones por día y 5 llamadas por semana. Tu agente atiende el chat; tú tomas las llamadas. Cada viernes cargas 3 números en tu Tablero — conversaciones, llamadas, pacientes — y el Tablero te dice dónde está la fuga: si es volumen, si es filtro o si es cierre. Nunca más vas a adivinar qué corregir.',
        tipo: 'COACH',
        es_estrella: false,
        tiempo_estimado: '20 min',
        orden: 8,
        ...
        coach_instruccion: 'EL TABLERO. Explicale su cuenta con SUS números, sin jerga: de la meta hacia atrás (10 pacientes ← 40 llamadas ← 57 agendas ← 300 conversaciones) y bajala a la semana. Dejale grabada la idea madre: el problema casi nunca es la técnica, es el volumen — y cuando no es volumen, es filtro; y cuando no es filtro, es cierre. Cerrá fijando el rito del viernes: 3 números, un diagnóstico, una acción. Si se asusta con los números, recordale que su agente atiende el chat: él solo toma 5 llamadas por semana.',
      },
    ],
  },
