...
export const TUTORIALES: Record<string, TutorialTecnico> = {
  'P2.2': {
    ...
    intro: 'Es la cuenta central desde donde vas a manejar tus anuncios. Suena técnico, pero son 10 minutos y lo hacés una sola vez.',
    pasos: [
      'Entrá a business.facebook.com y tocá "Crear cuenta".',
      'Poné el nombre de tu negocio, tu nombre y tu email de trabajo.',
      'Revisá tu email y confirmá (Meta te manda un enlace).',
      'Dentro, andá a "Configuración del negocio" → "Cuentas" → "Cuentas publicitarias" → "Agregar" → "Crear una nueva".',
      'Elegí tu país, tu moneda y la zona horaria correctas — esto no se puede cambiar después.',
      'Listo: ya tenés tu central de anuncios. La vas a usar cuando montes la campaña.',
    ],
    siFalla: 'Si te pide verificar tu negocio con documentos, podés saltarlo por ahora — no lo necesitás para empezar. Si algo no carga, probá desde una computadora (no el celular) — Meta funciona mejor así.',
  },
  'P4.5-pixel': {
    codigo: 'P4.5',
    ...
    pasos: [
      'En tu Business Manager, andá a "Administrador de eventos" → "Conectar orígenes de datos" → "Web" → "Pixel de Meta".',
      ...
      'Volvé a Meta y tocá "Verificar" — o instalá la extensión "Meta Pixel Helper" en Chrome, entrá a tu página, y si el ícono se pone azul, funciona.',
    ],
  ...
  'P4.5-agente': {
    ...
    pasos: [
      'En tu sistema (Mi Clínica / GHL), andá a la sección de conversaciones o automatizaciones.',
      ...
      'Definí las 3 preguntas clave que querés que haga (profesión del interesado, su problema principal, su urgencia).',
      'Conectá el botón "Agendar" a tu calendario.',
      'Probalo vos: escribile como si fueras un paciente y mirá que responda bien.',
    ],
  ...
  'P4.5b': {
    ...
    pasos: [
      '¿Ya tenés un dominio? Si no, comprá uno simple en Namecheap o Google Domains: tu nombre + ".com", cuesta ~$12 al año.',
      'En tu sistema, andá a "Configuración" → "Dominios" → "Agregar dominio".',
      'El sistema te muestra dos datos llamados "registros DNS" (son como coordenadas). Copialos.',
      'Entrá a donde compraste el dominio → "Administrar DNS" → pegá esos dos registros.',
      'Guardá y volvé a tu sistema. Tocá "Verificar".',
  ...
  'P4.4': {
    ...
    intro: 'Ya sabés cuál de tus anuncios funciona. Escalar es ponerle más presupuesto al ganador, con cabeza — no de golpe.',
    pasos: [
      ...
      'Mirá que el costo por mensaje se mantenga estable mientras subís. Si se dispara, frená y esperá.',
      'Cuando encuentres tu techo (donde el costo empieza a subir), quedate ahí. Ese es tu ritmo sostenible.',
    ],
    siFalla: 'Si al subir el presupuesto los resultados empeoran, bajá al nivel anterior y esperá 3 días. Escalar es paciencia, no apuro. Ramiro te lee los números si tenés dudas.',
  },
};
