  ...
  return (
    <div className="min-h-screen bg-ink flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-gold/8 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-gold/5 rounded-full blur-3xl" />
      </div>

      <div className="relative w-full max-w-md">
        {/* Logo */}
        <div className="text-center mb-10">
          <div className="inline-flex w-16 h-16 rounded-2xl bg-gradient-to-br from-gold to-goldhi items-center justify-center shadow-lg shadow-gold/20 mb-4">
        ...
        <div className="card-ios p-8 backdrop-blur-sm">
          <h2 className="text-lg font-medium text-cream mb-6">Iniciar sesión</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full bg-black/20 border border-[rgba(232,150,46,0.12)] rounded-xl py-3 pl-10 pr-4 text-sm text-cream placeholder-cream/30 focus:outline-none focus:border-gold/50 focus:ring-1 focus:ring-gold/50 transition-all disabled:opacity-50"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full bg-black/20 border border-[rgba(232,150,46,0.12)] rounded-xl py-3 pl-10 pr-10 text-sm text-cream placeholder-cream/30 focus:outline-none focus:border-gold/50 focus:ring-1 focus:ring-gold/50 transition-all disabled:opacity-50"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-gold hover:bg-goldhi disabled:opacity-50 disabled:cursor-not-allowed text-ink font-medium text-sm transition-all flex items-center justify-center gap-2 mt-2 shadow-lg shadow-gold/20"
            >
              {loading ? (
                <>
          ...
          <button
            ...
            className="w-full text-center text-xs text-gold/70 hover:text-gold mt-4 transition-colors"
          >
