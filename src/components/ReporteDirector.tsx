    ...
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 print:p-0 print:bg-white" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-cream/10 print:hidden">
          <p className="text-[10px] font-bold uppercase tracking-widest text-gold">El Reporte del Director</p>
          <div className="flex gap-2">
            ...
            <button onClick={onClose} className="p-2 rounded-lg hover:bg-cream/10 text-cream/60"><X className="w-4 h-4" /></button>
          </div>
        </div>
        ...
        <div className="p-8 print:p-10 text-[#EDEDED] print:text-[#1a1a1a]">
          <div className="text-center mb-8">
            <p className="text-[10px] uppercase tracking-[0.3em] text-gold font-bold">Tu Clínica Digital · Método CLINICA</p>
