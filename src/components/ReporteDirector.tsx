    ...
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 print:p-0 print:bg-white" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-cream/10 print:hidden">
          <p className="text-sm font-bold uppercase tracking-widest text-gold">El Reporte del Director</p>
        ...
        <div className="p-8 print:p-10 text-[#EDEDED] print:text-[#1a1a1a]">
          <div className="text-center mb-8">
            <p className="text-sm uppercase tracking-[0.3em] text-gold font-bold">Tu Clínica Digital · Método CLINICA</p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="border border-gold/25 print:border-gray-300 rounded-xl p-5 text-center">
              <p className="text-sm uppercase tracking-widest opacity-50">Día del programa</p>
              <p className="text-3xl font-light mt-1">{Math.min(diaPrograma, 90)} <span className="text-sm opacity-40">/ 90</span></p>
            </div>
            <div className="border border-gold/25 print:border-gray-300 rounded-xl p-5 text-center">
              <p className="text-sm uppercase tracking-widest opacity-50">Tu cinturón</p>
              <p className="text-2xl font-light mt-1">{cint.emoji} {cint.nombre}</p>
              <p className="text-sm opacity-40">{cint.metafora}</p>
            </div>
            <div className="border border-gold/25 print:border-gray-300 rounded-xl p-5 text-center">
              <p className="text-sm uppercase tracking-widest opacity-50">Sesiones del Camino</p>
              <p className="text-3xl font-light mt-1">{hechas} <span className="text-sm opacity-40">/ {totalSesiones}</span></p>
            </div>
            <div className="border border-gold/25 print:border-gray-300 rounded-xl p-5 text-center">
              <p className="text-sm uppercase tracking-widest opacity-50">Racha de sesiones</p>
          ...
          <div className="border-2 border-success/40 print:border-green-600 rounded-xl p-6 text-center mb-8">
            <p className="text-sm uppercase tracking-widest opacity-60">Tu clínica, en números</p>
          ...
          <div className="mb-6">
            <p className="text-sm uppercase tracking-widest opacity-50 mb-2">Lo que sigue</p>
          ...
          <p className="text-sm opacity-30 text-center italic">El taekwondo no se gana en un día de furia — se gana en mil días de presencia. · Tu Clínica Digital</p>
        </div>
      </div>
    </div>
  );
