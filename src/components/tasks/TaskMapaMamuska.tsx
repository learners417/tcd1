            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  ...
                  className="text-cream/30 hover:text-[#ff5e5e] transition-colors p-1"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-cream/50 mb-1 font-semibold">
                    Obstáculo (Matriz B)
                  </label>
                  <textarea
