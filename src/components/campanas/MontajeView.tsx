      ...
      <div className="flex flex-col lg:flex-row gap-4 flex-1 min-h-0">
        ...
        <div className="lg:w-[300px] lg:min-w-[300px] card-panel p-4">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-sm font-bold tracking-[0.15em] uppercase text-cream/45">
              Pasos
            </span>
              ...
              >
                <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5 ${
                  ...
                  {step.status === 'done' ? <CheckCircle2 className="w-3.5 h-3.5" /> :
                   step.status === 'active' ? <span className="text-sm font-bold">{step.id}</span> :
                ...
                <div>
                  ...
                  <div className="text-sm text-cream/25 mt-0.5 leading-relaxed">
                    {step.description}
                  </div>
                </div>
              </div>
          ...
          <div className="mt-4 p-3 rounded-xl bg-gold/5 border border-dashed border-gold/15">
            ...
            <div className="text-sm text-cream/45 leading-relaxed">
            ...
            {messages.map((msg) => (
              <div key={msg.id} className={`flex ${msg.role === 'user' ? 'justify-end' : 'items-end gap-2'}`}>
                ...
                <div className={`max-w-[85%] rounded-2xl px-4 py-3 ${
                  ...
                  {msg.content ? (
                    <div className="prose prose-invert prose-sm max-w-none text-cream/85 text-sm leading-relaxed [&>*:first-child]:mt-0 [&>*:last-child]:mb-0 [&_strong]:text-cream [&_p]:my-1.5">
