        ...
        <div className="space-y-3">
          {campanas.map((c) => (
            ...
            >
              ...
              <span
                className="inline-block text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full border mb-3"
                style={{
              ...
              <div className="flex flex-wrap gap-4 text-[11px] text-cream/45">
