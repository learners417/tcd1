    ...
    <div className="animate-in fade-in duration-500 max-w-5xl mx-auto">
      ...
      {campanas.length === 0 ? (
        <div className="card-panel p-12 text-center">
          ...
          <p className="text-sm text-cream/55 mb-1">Todavia no hay campañas guardadas.</p>
          <p className="text-sm text-cream/25">Crea tu primera campaña desde el flujo completo o un modulo directo.</p>
        </div>
      ) : (
        <div className="space-y-3">
          {campanas.map((c) => (
            ...
            >
              ...
              <span
                className="inline-block text-sm font-bold uppercase tracking-wider px-2 py-0.5 rounded-full border mb-3"
                style={{
